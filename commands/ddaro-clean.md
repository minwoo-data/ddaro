---
name: ddaro:clean
description: "Post-merge cleanup. Delete merged branches and remove their worktrees. Safe deletion only (refuses unmerged)."
argument-hint: "[name]"
allowed-tools: [Bash, Read, Write, Edit, Glob, Grep]
---

Read `${CLAUDE_PLUGIN_ROOT}/skills/ddaro/SKILL.md` section "## `/ddaro clean [name]`" and execute with `$ARGUMENTS` as optional name.
